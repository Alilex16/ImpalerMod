...
public abstract class AbstractImpalerCard extends CustomCard{
	...
	public AbstractImpalerCard(String id, String name, String img, int cost, String rawDescription, CardType type, CardRarity rarity, CardTarget target, int cardPool){
		super(id, name, ImpalerMod.getResourcePath(img), cost, rawDescription, type, AbstractCardEnum.IMPALER, rarity, target);
	}

	//public AbstractImpalerCard(String id, String name, String img, int cost, String rawDescription, CardType type, CardRarity rarity, CardTarget target, int cardPool, CardColor color){
	//	super(id, name, ImpalerMod.getResourcePath(img), cost, rawDescription, type, AbstractCardEnum.IMPALER, rarity, target, color);
	//}
			...
			if (!Settings.hideCards) {
				...
				if (!this.isFlipped) {
					...
					if (type == CardType.CURSE) {
						color = AbstractCardEnum.IMPALER;
					}
